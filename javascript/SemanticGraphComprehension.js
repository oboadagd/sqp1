function semanticGraphComprehension(request, response ,ctx, solrServer, solrServerFactory) {
    // Configuration
    var stage = "SemanticGraphComprehension";
    var dictionary = "demo_comprehension";
    var debug = true;
